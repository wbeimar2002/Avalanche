...
using Avalanche.Security.Server.Test.Managers;

[assembly: AssemblyTrait("Category", "SkipWhenLiveUnitTesting")]
namespace Avalanche.Security.Server.Integration
{
    public class ServerCoreUserManagerIntegration : IUsersManagerTest
    {
        private readonly UsersManagerTest _tests;

        public ServerCoreUserManagerIntegration(ITestOutputHelper output) =>
            _tests = new UsersManagerTest(output, GetInMemoryDbContextOptions(output));
