    ...
    public partial class DeviceManagerTests
    {
        ...
        public void PgsExecutePlayVideoShouldReturnResponse()
        {
            CommandViewModel commandViewModel = new CommandViewModel()
            {
                ...
                Type = "OfferType",
                Devices = new List<VideoDeviceViewModel>() { new VideoDeviceViewModel() { Id = "Preview", Name = string.Empty, Type = string.Empty } },
                Destinations = new List<VideoDeviceViewModel>(),
