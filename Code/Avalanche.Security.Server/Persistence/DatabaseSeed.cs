    ...
    public class DatabaseSeed
    {
        public static void Seed(SecurityDbContext context, IPasswordHasher passwordHasher)
        {
            ...
            if (context.Users.Count() == 0)
            {
                ...
                {
                    new User { FirstName = "Main", LastName ="Administrator", LoginName = "admin@admin.com", Password = passwordHasher.HashPassword("12345678") },
                    new User { FirstName = "Common", LastName ="User", LoginName = "common@common.com", Password = passwordHasher.HashPassword("12345678") },
                };
